...
from s1.records.base import InvalidFieldLength, BaseRecordSpec


def test_validate_number_of_fields_correct(basic_spec: BaseRecordSpec) -> None:
    """ Our basic_spec contains 3 static fields + 1 record_id, this should not raise"""
    basic_spec.validate_number_of_fields(4)


def test_validate_number_of_fields_short(basic_spec: BaseRecordSpec) -> None:
